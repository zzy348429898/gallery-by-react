...
class ImgFigure extends React.Component<any, any> {
  constructor(props) {
    super(props);
  }
  handleClick(e) {
  ...
  render() {
    ...
    return (
      <figure
        ...
        style={styleObj}
        ref={"imgFigure" + this.props.data.id}
...
//控制组件
class ControllerUnits extends React.Component<any, any> {
  constructor(props) {
    super(props);
  }
  handleClick(e) {
  ...
  render() {
    return (
      <span
        className={classNames(
          "controller-unit",
          this.props.arrange.isCenter && "is-center",
          this.props.arrange.isInverse && "is-center-inverse"
        )}
        onClick={this.handleClick.bind(this)}
      ></span>
    );
...
class GalleryByReactApp extends React.Component<any, any> {
  centerPos;
  hPosRange;
  vPosRange;
  constructor(props) {
  ...
  */
  ...
  componentDidMount() {
    ...
    this.hPosRange.rightSecX = [halfStageW + halfImgW, stageW - halfImgW];
    this.hPosRange.topSecX = [halfStageW - halfImgW * 2, halfStageW];
    this.vPosRange.leftSecY = [-halfImgH, stageH - halfImgH];
    ...
    imageDatas.forEach(
      function (value, index) {
        ...
        controllerUnits.push(
          <ControllerUnits
            data={value}
            key={"controllerNav" + index}
            ref={"controllerNav" + index}
            arrange={this.state.imgsArrangeArr[index]}
            inverse={this.inverse(index)}
            center={this.center(index)}
          />
